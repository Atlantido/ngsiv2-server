...
import eu.hopu.exception.MismatchIdException;
import eu.hopu.exception.MissingRequestParameterException;
...
public class NgsiValidation {
    ...
    private void checkContextElement(ContextElement contextElement) throws MissingRequestParameterException {
        // TODO los cambios en el modelo de la libreria cliente generan que este metodo de validacion falle
//        if (contextElement.getId() == null) {
//            throw new MissingRequestParameterException("entityId", "EntityId");
//        }
//        checkEntityId(contextElement.getId());
